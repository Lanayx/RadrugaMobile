...
export class UniqueMissionsManager {
    private static missionsDictionary = {
    ...
    public static goToMission(id: string) {
        require([`game/uniqueMissions/${this.missionsDictionary[id]}`], (mission) => {
            mission.navigate();
        });
    }

    public static getMissionName(id: string) {
