...
interface Cordova {
     ...
     */
    exec(success: (data?: any) => any, fail: () => any, service: string, action: string, args?: string[]): void;
    ...
    define(moduleName: string, factory: (requir: any, exports: any, modul: any) => any): void;
